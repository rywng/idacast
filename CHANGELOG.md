...
## [0.1.10](https://github.com/rywng/idacast/compare/v0.1.9...v0.1.10) - 2025-12-22

### Fixed

- *(update)* Use more efficient update schedule

## [0.1.9](https://github.com/rywng/idacast/compare/v0.1.8...v0.1.9) - 2025-12-22

### Added

- *(challenges)* dim past schedules
- *(translation)* Add support for work and partial challenges

### Other

- *(crates)* Update the keywords for this program

## [0.1.8](https://github.com/rywng/idacast/compare/v0.1.7...v0.1.8) - 2025-12-13

### Added

- *(ui)* Fine tune the colors again
...
- *(lint)* allow dead code for Schedule interface
- *(deps)* Update version of nixpkgs dependency
- *(ui)* Remove redundant borrowing in code
- *(fmt)* Format code
